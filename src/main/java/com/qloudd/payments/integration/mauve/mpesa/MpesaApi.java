...
public class MpesaApi {
    ...
    public Optional<String> authenticate() throws IOException {
        ...
        log.info("Auth Response : {} {}", response.body(), jsonObject.getString("access_token"));
    ...
    public MpesaResponseWrapper<StkSimulationResponse> STKPushSimulation(OnlinePayment stkSimulationRequest) throws IOException {
        JSONArray jsonArray = new JSONArray();
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("BusinessShortCode", stkSimulationRequest.getBusinessShortCode());
        jsonObject.put("Password", stkSimulationRequest.getPassword());
        jsonObject.put("Timestamp", stkSimulationRequest.getTimestamp());
        jsonObject.put("TransactionType", stkSimulationRequest.getTransactionType());
        jsonObject.put("Amount", stkSimulationRequest.getAmount());
        jsonObject.put("PhoneNumber", stkSimulationRequest.getPhoneNumber());
        jsonObject.put("PartyA", stkSimulationRequest.getPartyA());
        jsonObject.put("PartyB", stkSimulationRequest.getPartyB());
        jsonObject.put("CallBackURL", stkSimulationRequest.getCallbackURL());
        jsonObject.put("AccountReference", stkSimulationRequest.getAccountReference());
        jsonObject.put("QueueTimeOutURL", stkSimulationRequest.getCallbackURL());
        jsonObject.put("TransactionDesc", stkSimulationRequest.getTransactionDescription());
        ...
        StkSimulationResponse paymentResponse = mapper.readValue(response.body().string(), StkSimulationResponse.class);
        return MpesaResponseWrapper
